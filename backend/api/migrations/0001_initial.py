# Generated by Django 5.1.4 on 2025-02-07 18:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialization', models.CharField(choices=[('PT', 'Personal Trainer'), ('NT', 'Nutritionist'), ('YT', 'Yoga Teacher'), ('FT', 'Fitness Trainer'), ('WC', 'Wellness Coach')], max_length=2)),
